  ...
  <div class="container login-container d-flex justify-content-center">
    <div class="col-md-6 login-form">
      <section class="text-center">
        <h3 class="text-accent ahead">Por favor identificate</h3>
      ...
      >
        ...
        <button type="button" class="btn-close" @click="resetErrors"></button>
      </div>
      <form @submit="checkForm" method="post">
        ...
        <div class="input-group mb-3">
          <label>
            ¿Eres un empleado?
            <RouterLink class="btnGhost" to="/loginE"> Ingresa aqui</RouterLink>
          </label>
        </div>
      </form>
    </div>
